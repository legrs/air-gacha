...
tisso_kazu =           (nowData.match( /0/g) || [] ).length; 
sanso_kazu =           (nowData.match( /1/g) || [] ).length; 
arugon_kazu =          (nowData.match( /2/g) || [] ).length; 
nisankatanso_kazu =    (nowData.match( /3/g) || [] ).length; 
neon_kazu =            (nowData.match( /4/g) || [] ).length; 
heriumu_kazu =         (nowData.match( /5/g) || [] ).length; 
metan_kazu =           (nowData.match( /6/g) || [] ).length; 
kuriputon_kazu =       (nowData.match( /7/g) || [] ).length; 
nisankaiou_kazu =      (nowData.match( /8/g) || [] ).length; 
suiso_kazu =           (nowData.match( /9/g) || [] ).length; 
issannkanitisso_kazu = (nowData.match( /10/g) || [] ).length; 
kisenon_kazu =         (nowData.match( /11/g) || [] ).length; 
ozon_kazu =            (nowData.match( /12/g) || [] ).length; 
nisankatisso_kazu =    (nowData.match( /13/g) || [] ).length; 
youso_kazu =           (nowData.match( /14/g) || [] ).length; 
